...
export const ProductCategories = ({ className, withContainer = true }: { className?: string; withContainer?: boolean }) => {
  return (
    <PageLayer withContainer={withContainer} className={cn("grid items-end gap-7", "sm-7:grid-cols-2 md-3:grid-cols-3", className)}>
